...
class Compras extends BaseController
{
    ...
    function generaCompraPdf($id_compra)
    {
        ...
        $pdf->image(base_url() . '/images/tirza.jpg',175,10,25,25);

        $pdf->Cell(50,5,$nombreTienda,0,1,'L');
        $pdf->Cell(50,5,utf8_decode('Dirección: ').$direccionTienda,0,1,'L');

        $pdf->Cell(50,5,utf8_decode('Fecha y Hora: ').$datosCompra['fecha_alta'],0,1,'L');
        ...
        $pdf->Cell(196,5,'Detalle del producto',1,1,'C',1);
