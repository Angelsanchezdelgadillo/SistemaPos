...
class Productos extends BaseController
{
    ...
    public function autocompleteData()
    {
        ...
        $producto = $this->productos->like('codigo', $valor)->where('activo', 1)->findAll();
        if (!empty($producto)) {
    ...
    public function mostrarExel()
    {
        ...
        $hoja->setCellValue("C5",'Existencia');
        ...
        foreach ($datosProductos as $producto) {
             ...
             $hoja->setCellValue("C".$fila,$producto['existencia']);
